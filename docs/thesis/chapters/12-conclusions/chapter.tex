...
La desagregación muestra dos patrones complementarios. Las rentas de minería y
carbón se asocian negativamente con $ECI$ ($\beta=-0,0136$, $p=0,001$), mientras
que las rentas de petróleo y gas se asocian negativamente con $DIVX$
($\beta=-0,0048$, $p=0,001$). Ambos resultados conservan el signo en las 49
exclusiones de países y mantienen significación con bootstrap. Sin embargo, las
pruebas de igualdad de los coeficientes directos no rechazan igualdad al 5\%.
Estos patrones sugieren heterogeneidad sectorial, pero no demuestran que cada
recurso opere mediante un mecanismo exclusivo.
