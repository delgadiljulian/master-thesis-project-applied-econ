...
1980--2022.
	...
	\begin{enumerate}
		...
		sistema (System GMM).\footnote{El estimador System GMM combina ecuaciones en diferencias y en niveles, utilizando rezagos internos como instrumentos. Su uso es habitual en paneles dinámicos cuando existe persistencia temporal, efectos fijos y posible endogeneidad de algunas covariables.} La validez de esta especificación se evaluará
