...
empírico. La selección definitiva de indicadores responde a criterios de
	...
	transformación \textit{within}.\footnote{En este diagnóstico, la transformación
	\textit{within} retira de cada regresor los componentes asociados a los efectos
	fijos de país y de año, de modo que el factor de inflación de la varianza se
	calcule sobre la variación residual utilizada por la estimación.} Estas pruebas se interpretan como diagnósticos y no
	...
	(\textcite{Cameron2008};
	\textcite{Roodman2019}), exclusión iterativa de países
	...
	En sexto lugar, se estiman por separado las dos variantes completas de M3 que
