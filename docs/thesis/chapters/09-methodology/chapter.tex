...
% =====================================
	...
	1980--2022, sujeto a la disponibilidad de cada fuente. No obstante, dado
	...
	recursos naturales mediante el indicador $DRES$.\footnote{El horizonte
		general 1980--2022 permite capturar la etapa de mayor integración
	...
	desbalanceado, en función de la
