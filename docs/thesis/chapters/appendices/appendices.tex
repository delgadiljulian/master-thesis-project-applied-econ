...
\begin{document}
	...
	La \autoref{tab:fuentes_datos} resume los indicadores definidos para la construcción del panel empírico, sus fuentes internacionales y la cobertura potencial de los insumos conservados en \texttt{data/raw}. Cada indicador tiene una única definición activa. El panel maestro contiene una grilla fija de 55 países y 1.430 observaciones país--año para 1996--2021; la muestra efectiva de cada ecuación corresponde a la intersección de sus variables disponibles, sin imputar faltantes.
	...
	\begin{footnotesize}
		\begin{longtable}{
			...
			& Dependencia externa de recursos
			& Exportaciones de recursos naturales no renovables del subsuelo / exportaciones totales de mercancías (DRES)
			& Atlas of Economic Complexity (SITC Rev. 2); elaboración propia
			& 1990--1995 \\

			Rentas extractivas
			& Intensidad macroeconómica de las rentas
			& Suma de rentas de petróleo, gas natural, carbón y minerales (\% del PIB) (RENTS)
			& World Bank (WDI)
			& 1980--2021 \\
			...
			& Atlas of Economic Complexity (API GraphQL)
			& 1995--2022 \\

			Transformación estructural externa
			& Diversificación exportadora
			& Complemento del índice de concentración exportadora ($DIVX=1-HHI$)
			& Atlas of Economic Complexity; elaboración propia
			& 1990--2022 \\

			Estructura exportadora
			& Concentración exportadora
			& HHI entre productos SITC Rev. 2 clasificados; excluye servicios y \texttt{XXXX}
			& Atlas of Economic Complexity; elaboración propia
			& 1990--2022 \\

			Abundancia de recursos
			& Renta petrolera por habitante
			& Renta petrolera real por habitante (OILPC)
			& World Bank (WDI); elaboración propia
			& 1980--2021 \\

			Abundancia de recursos
			& Renta gasífera por habitante
			& Renta de gas natural real por habitante (GASPC)
			& World Bank (WDI); elaboración propia
			& 1980--2021 \\

			Abundancia de recursos
			& Renta carbonífera por habitante
			& Renta del carbón real por habitante (COALPC)
			& World Bank (WDI); elaboración propia
			& 1980--2021 \\

			Estructura exportadora
			& Especialización primaria no energética
			& Participación de las secciones SITC Rev. 2 0, 1, 2 y 4 y la división 68 en las exportaciones de mercancías (PEXP)
			& Atlas of Economic Complexity; elaboración propia
			& 1990--2022 \\

			Estructura exportadora
			& Especialización en combustibles
			& Participación de la sección SITC Rev. 2 3 en las exportaciones de mercancías (FEXP)
			& Atlas of Economic Complexity; elaboración propia
			& 1990--2022 \\

			Instituciones
			& Calidad institucional
			& Promedio de Control of Corruption, Rule of Law y Government Effectiveness (INST)
			& Worldwide Governance Indicators (WGI)
			& 1996--2022 \\

			Capacidades productivas
			& Capital humano
			& Índice derivado de los años promedio de escolaridad de adultos de 25 años o más mediante la función de retornos educativos de PWT (HUMCAP)
			& PNUD, \textit{Human Development Report 2025}; construcción propia
			& 1990--2023 \\

			Capacidades productivas
			& Innovación
			& $\log(1+\text{artículos científicos y técnicos por millón de habitantes})$ (INNOV)
			& World Bank (WDI)
			& 1980--2022 \\

			Capacidades productivas
			& Conectividad
			& Personas que utilizan internet (\% de la población; \texttt{IT.NET.USER.ZS}) (NET)
			& World Bank (WDI)
			& 1980--2022 \\

			Macroeconomía
			& Volatilidad de los términos de intercambio de commodities
			& Desviación estándar móvil de cinco años de la variación logarítmica anual de \texttt{CEMPI\_CTOTNX\_TT}, con ponderaciones fijas \texttt{H\_FW\_IX} (VOL)
			& IMF Commodity Terms of Trade
			& 1962--2022 \\

			Macroeconomía
			& Tipo de cambio real
			& $\log(\texttt{pl\_gdpo})$; un aumento representa apreciación real (RER)
			& Penn World Table 11.0
			& 1950--2023 \\

			Control
			& Nivel de desarrollo
			& $\log(PIB\text{ per cápita PPA constante})$ (\texttt{NY.GDP.PCAP.PP.KD}; LOG\_GDPPC)
			& World Bank (WDI)
			& 1980--2022 \\

			Control fiscal
			& Consumo gubernamental
			& Consumo final del gobierno general (\% del PIB; serie 16, componente 3) (GOVCONS)
			& UN National Accounts Main Aggregates
			& 1970--2024 \\

			Canal financiero
			& Profundidad financiera
			& Crédito doméstico al sector privado otorgado por bancos (\% PIB; FD.AST.PRVT.GD.ZS) (FIN)
			& World Bank (WDI)
			& 1980--2025 \\

			\hline
			\multicolumn{5}{p{14.5cm}}{\textit{Nota: Los períodos consignan la cobertura potencial de los insumos raw. El panel maestro fija 55 países y 26 años para 1996--2021, pero conserva explícitamente los faltantes de cada indicador. $ECI$, $PEXP$, $FEXP$, $INNOV$, $GOVCONS$, $HHI$ y $DIVX$ cubren las 1.430 observaciones; las demás variables superan el 80\% de cobertura individual. WDI se conserva como referencia de contraste para $GOVCONS$, pero no se mezcla con la serie activa de Naciones Unidas. En $FIN$, la definición amplia \texttt{FS.AST.PRVT.GD.ZS} también se conserva solo como contraste y no se mezcla con la serie bancaria activa. $DRES$ se utiliza únicamente para seleccionar los países con el umbral de 20\%. $HHI$ se incluye solo en el modelo con $ECI$ y se excluye cuando $DIVX=1-HHI$ es el resultado complementario.}} \\
		\end{longtable}
	\end{footnotesize}
