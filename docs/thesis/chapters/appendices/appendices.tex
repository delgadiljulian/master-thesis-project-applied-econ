...
\begin{document}
	...
	\begin{footnotesize}
		\begin{longtable}{
			...
			& Exportaciones de recursos naturales no renovables / exportaciones totales (DRES)
			& UN Comtrade; World Bank; elaboración propia
			& 1980--2022 \\

			Rentas extractivas
			& Intensidad macroeconómica de las rentas
			& Rentas de recursos naturales (\% del PIB) (RENTS)
			& World Bank (WDI)
			& 1970--2022 \\
			...
			& Elaboración propia con base en HHI
			& 1980--2022 \\
			...
			& Dotación de petróleo
			& Producción o reservas de petróleo per cápita (OILPC)
			& World Bank; EIA; fuentes internacionales comparables
			& 1980--2022 \\

			Abundancia de recursos
			& Dotación de gas
			& Producción o reservas de gas per cápita (GASPC)
			& World Bank; EIA; fuentes internacionales comparables
			& 1980--2022 \\

			Abundancia de recursos
			& Dotación de carbón
			& Producción o reservas de carbón per cápita (COALPC)
			& World Bank; EIA; fuentes internacionales comparables
			& 1980--2022 \\

			Estructura exportadora
			& Especialización primaria
			& Participación de exportaciones primarias en el total exportado (PEXP)
			& UN Comtrade; World Bank; elaboración propia
			& 1980--2022 \\

			Estructura exportadora
			& Especialización en combustibles
			& Participación de exportaciones de combustibles en el total exportado (FEXP)
			& UN Comtrade; World Bank; elaboración propia
			& 1980--2022 \\
			...
			Capacidades productivas
			& Conectividad
			& Acceso o uso de internet / infraestructura digital (NET)
			& World Bank (WDI); ITU
			& 1990--2022 \\
