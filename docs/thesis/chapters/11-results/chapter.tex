...
\begin{document}
	...
	La muestra de referencia corresponderá al umbral de dependencia externa de recursos $\theta=20\%$, mientras que los umbrales de 30\% y 40\% se utilizarán en los ejercicios de sensibilidad. Antes de cruzar la lista de países con las demás variables econométricas, estas reglas identifican 55, 49 y 42 países, respectivamente. Esta presentación permitirá distinguir entre diferencias atribuibles a la especificación econométrica y diferencias asociadas a la composición de la muestra.
