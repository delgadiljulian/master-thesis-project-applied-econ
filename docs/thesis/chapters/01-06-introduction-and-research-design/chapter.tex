...
\thesisendchap{planteamiento}
	...
	\begin{enumerate}
		...
		\item Examinar la estabilidad de los resultados mediante inferencia
		bootstrap, exclusión iterativa de países y observaciones influyentes,
		tendencias lineales por país, sensibilidad temporal de 2014 y
		desagregación de las rentas.
