...
\hypersetup{
	...
	pdftitle={Rentas extractivas y transformación estructural externa en economías dependientes de recursos naturales no renovables del subsuelo (1996--2022)},
		...
		\begin{center}
			\begin{minipage}{0.9\textwidth}
				...
				{\cambriafont\fontsize{18}{22}\selectfont
					Rentas extractivas y transformación estructural externa en economías dependientes de recursos naturales no renovables del subsuelo (1996--2022)}
			\end{minipage}
		\end{center}
