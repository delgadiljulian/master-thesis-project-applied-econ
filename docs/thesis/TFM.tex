...
\newcommand{\thesissource}[1]{%
	\par\smallskip
	{\centering\footnotesize\itshape Fuente: #1\par}%
}
...
% Ajuste de parámetros de flotantes para permitir imágenes a ancho de texto sin páginas en blanco aisladas
...
\hypersetup{
	...
	pdftitle={Rentas extractivas y transformación estructural externa en economías dependientes de recursos naturales no renovables del subsuelo (1996--2021)},
