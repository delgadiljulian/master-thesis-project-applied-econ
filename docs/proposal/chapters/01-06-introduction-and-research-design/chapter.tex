% Content-only chapter block for PTFM.tex
...
\begin{document}
	...
	En este contexto, la investigación busca contribuir a la literatura sobre desarrollo económico y economías extractivas mediante un análisis comparado que vincula dependencia externa de recursos, rentas extractivas, transformación estructural y acumulación de capacidades productivas. Tras presentar la pregunta, la justificación y el planteamiento del problema, el documento precisa la contribución esperada, los objetivos y las hipótesis de la investigación. El resto del proyecto se organiza de la siguiente manera: el \autoref{chap:marco-teorico} desarrolla el marco teórico y conceptual del estudio; el \autoref{chap:literatura-empirica} revisa la literatura empírica relevante; el \autoref{chap:metodologia} presenta la estrategia metodológica y las técnicas empíricas a utilizar; el \autoref{chap:datos-variables} describe los datos y la construcción de variables; y finalmente se incorpora el cronograma de trabajo y los anexos de apoyo.
...
\thesisendchap{planteamiento}
	...
	% CONTRIBUCIÓN
	% =====================================================
	\chapter{Contribución de la investigación}
	\label{chap:contribucion}
	\thesisstartchap{contribucion}

	La contribución de esta investigación no consiste en proponer una teoría completamente nueva sobre la relación entre recursos naturales y desarrollo, ni en afirmar que el uso de indicadores de complejidad económica sea inédito. El problema se inscribe en una literatura acumulada que incluye los debates clásicos sobre la maldición de los recursos naturales y la enfermedad holandesa \parencite{Auty1993,Corden1982,Sachs1995,Sachs2001}, las discusiones sobre diversificación, encadenamientos y capacidades productivas \parencite{Hirschman1958,Agosin2012,Harding2016}, y los aportes sobre \textit{product space} y complejidad económica desarrollados desde mediados de la década de 2000 \parencite{Hausmann2007,Hidalgo2009,Hausmann2014}. Sobre esa base, una literatura empírica más reciente ha examinado vínculos próximos entre recursos naturales, rentas extractivas, dependencia de recursos y complejidad económica en muestras regionales y paneles amplios de países \parencite{Ajide2022,Avom2022,Canh2020,Destek2023,Kelly2024,Owjimehr2024,Zhang2023}. En diálogo con esta trayectoria más amplia, el aporte de la tesis radica en reorganizar empíricamente el problema de la transformación estructural en economías dependientes de recursos naturales no renovables, distinguiendo entre el criterio que define el universo de análisis, los mecanismos explicativos y los resultados que se busca explicar. En ese sentido, el trabajo no se presenta como una réplica ni como una sustitución de dicha literatura, sino como una aplicación comparada orientada a identificar qué canales se asocian con trayectorias distintas de complejidad y diversificación exportadora dentro de economías con una inserción extractiva común.

	\section{Delimitación de la muestra y separación analítica entre dependencia externa y rentas}
	\label{sec:contribucion-muestra-rentas}

	El primer elemento metodológico de la tesis consiste en adoptar y adaptar un criterio utilizado en la literatura: medir la dependencia externa como la participación de las exportaciones de recursos naturales no renovables en las exportaciones totales. Varios estudios analizan la relación entre rentas, abundancia o agotamiento de recursos naturales y complejidad económica en muestras amplias de países, países en desarrollo o economías ricas en recursos, y algunos distinguen incluso entre petróleo, minería y gas \parencite{Canh2020,Hoang2023,Kelly2024,Li2024,Ul-Durar2023,Valentine2024,Zhang2023}. A partir de esos antecedentes, esta investigación utiliza dicho criterio para delimitar la muestra durante un período base y evalúa la sensibilidad de esa delimitación mediante umbrales alternativos de dependencia externa ($\theta=40\%, 50\%, 60\%$). En cambio, las rentas de recursos naturales como porcentaje del PIB se incorporan como una variable explicativa dentro del modelo econométrico. El aporte, por tanto, no reside en la originalidad del indicador, sino en la separación analítica entre dependencia externa como criterio de selección y rentas extractivas como mecanismo explicativo, lo que permite ordenar con mayor precisión el objeto empírico de la tesis y evitar una confusión frecuente entre condición estructural de partida y canal económico de transmisión.

	\section{Medición de la transformación estructural externa}
	\label{sec:contribucion-variables-resultado}

	La segunda contribución consiste en diferenciar dos resultados de transformación estructural externa. La literatura sobre complejidad económica ha utilizado ampliamente el Índice de Complejidad Económica (ECI) para aproximar capacidades productivas reveladas y sofisticación exportadora \parencite{Hausmann2007,Hidalgo2009,Hausmann2014}, y una literatura empírica posterior lo ha aplicado al análisis de recursos naturales, rentas y especialización extractiva \parencite{Ajide2022,Canh2020,Hoang2023,Owjimehr2024,Valentine2024,Zhang2023}. En este marco, el ECI se mantiene como variable dependiente principal, pero se complementa con una medida de diversificación exportadora definida como $DIVX=1-HHI$, donde $HHI$ corresponde al índice de concentración de Herfindahl--Hirschman. Esta segunda variable no sustituye al ECI: permite distinguir entre sofisticación de la canasta exportadora y menor concentración exportadora, dos dimensiones relacionadas pero no equivalentes de la transformación estructural externa.

	\section{Integración de canales explicativos}
	\label{sec:contribucion-canales}

	La tercera contribución consiste en organizar en un mismo marco empírico distintos canales explicativos que la literatura suele analizar por separado. Algunos trabajos enfatizan el papel de las instituciones, la estabilidad política o la calidad institucional en economías ricas en recursos o en paneles amplios de países \parencite{Ajide2022,Avom2022,AvomNdoya2024,Olaniyi-Odhiambo2025,Olaniyi-Odhiambo2025-3,Owjimehr2024}; otros destacan el desarrollo financiero, la innovación, el capital humano, los derechos de patente o el nivel de ingreso como condiciones que pueden modificar la relación entre recursos y complejidad \parencite{Alvarado2023,Li2024,Mayer2023,Sweet2019,Valentine2024,YaseminYalta2021}. A partir de estos antecedentes, el modelo integra un canal institucional, asociado a la calidad institucional y a su interacción con las rentas extractivas; un canal de abundancia, vinculado con petróleo, gas y minería; un canal estructural, relacionado con concentración y especialización exportadora; un canal macroeconómico, asociado a volatilidad y tipo de cambio real; un canal de capacidades productivas, aproximado mediante capital humano, innovación y conectividad; y canales fiscales y financieros. El aporte no reside en afirmar que cada canal sea novedoso por separado, sino en evaluarlos conjuntamente para comparar cómo se asocian con resultados de complejidad y diversificación dentro de economías dependientes de recursos no renovables.

	\section*{Síntesis del aporte}

	En conjunto, la contribución esperada es de carácter metodológico y empírico: ofrecer una aplicación comparada que ordena la muestra, las variables de resultado y los canales explicativos de manera consistente con la pregunta de investigación. El diseño propuesto se centra en países dependientes de petróleo, gas y minería durante el período principal de estimación 1996--2022 y estima especificaciones de datos de panel con efectos fijos para controlar por heterogeneidad no observable entre países y por shocks temporales comunes. Por tanto, el alcance de la tesis no consiste en sobredimensionar una novedad teórica ni en establecer inferencias causales fuertes, sino en aportar evidencia organizada sobre las condiciones bajo las cuales las rentas extractivas se asocian con mayores o menores niveles de transformación estructural externa.

	\thesisendchap{contribucion}
