...
//
// Archivo: 03_resource_disaggregation.do (Versión Codex)
// Ubicación: scripts/econometrics/stata-peer-2/
// Contenido: Secciones 9 a 14 del análisis econométrico desagregado
// Extensión: Desagregación de RENTS entre Hidrocarburos y Minería
// Requisitos: Completar los archivos 01 y 02 antes de iniciar esta extensión
...
* Buscar dinámicamente hasta 5 niveles superiores y validar la ubicación del proyecto
...
// B.3. Definir las entradas, salidas y el log del archivo 03

* Definir las rutas globales del proyecto para la versión stata-peer-2
global OUTPUT_ROOT               "$PROJECT_ROOT/outputs/econometrics/stata-peer-2"
...
* Iniciar el archivo de registro de ejecución para el script 03
log using "$OUTPUT_DISAGG_LOGS/03_resource_disaggregation.log", text replace name(disaggregation_log)
...
display as text "Dependencias externas de la inicialización y la sección 9: ninguna."
...
if _rc {
    ...
    display as error "Ejecute primero 02_econometric_models.do."
    exit 601
}
...
display as result "Inicialización del archivo 03 completada; comienza la sección 9."
...
// 9.1. Confirmar las definiciones y la identidad contable
...
// 9.2. Fijar la relación con los modelos agregados

* Mantener ECI_TWFE_MAIN y DIVX_TWFE_MAIN como especificaciones agregadas centrales


// 9.3. Definir las interacciones institucionales
...
// 9.4. Predefinir regresores y tratamiento de los controles per cápita
...
// 9.5. Construir y validar las muestras comparables
...
// 9.6. Predefinir pruebas e interpretación
...
// 9.7. Exportar la evidencia del diseño y cerrar el Control G
...
// 10.1. Cargar la base analítica sin modificarla
...
// 10.2. Validar cobertura, dominios e identidad contable
...
// 10.3. Evaluar variación temporal y colinealidad
...
// 10.4. Revisar distribuciones y observaciones influyentes
...
// 11.1. Definir la muestra ECI comparable
...
foreach command in reghdfe esttab {
    ...
    if _rc {
        display as error "No se encontró `command'; ejecute primero el archivo 02."
        exit 199
    }
}
...
// 11.2. Estimar la especificación ECI aprobada
...
// 11.3. Contrastar los componentes de RENTS
...
// 11.4. Comparar con el modelo ECI agregado
...
// 12.1. Definir la muestra DIVX comparable
...
// 12.2. Estimar la especificación DIVX aprobada
...
// 12.3. Contrastar los componentes de RENTS
...
// 12.4. Comparar con el modelo DIVX agregado
...
// 13.1. Calcular efectos marginales según INST
...
if _rc {
    display as error "No se encontró boottest; ejecute primero el archivo 02."
    exit 199
}
...
// 13.2. Evaluar sensibilidad a observaciones y países
...
// 13.3. Aplicar inferencia alternativa
...
// 13.4. Comparar estabilidad entre componentes
...
// 14.1. Exportar resultados numéricos
...
// 14.2. Crear tablas y figuras comparables
...
// 14.3. Crear el índice reproducible de outputs
...
// 14.4. Ejecutar y cerrar el Control J
...
* Informar el alcance ejecutado y cerrar el registro del archivo 03
display as result "Sección 14 completada: exportaciones finales e índice generados."
display as result "Archivo 03 finalizado: secciones 9 a 14 completadas sin errores."
