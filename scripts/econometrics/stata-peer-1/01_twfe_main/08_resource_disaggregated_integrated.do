...
//
// Archivo: 08_resource_disaggregated_integrated.do (Versión Peer-1)
...
log using "$OUTPUT_LOGS/08_resource_disaggregated_integrated.log", text replace name(disagg_integ_log)
...
display as result "Resultados finales exportados en: $OUTPUT_INTEG y $OUTPUT_FINAL"
display as result "---------------------------------------------------------"
