# CAPA: PROCESSED
# VARIABLES: HHI y DIVX
# ENTRADAS: data/raw/atlas/ y data/processed/dres/
# SALIDAS: data/processed/hhi_divx/
...
helper_path <- c(
  ...
  # Buscar el helper cuando la consola está ubicada en scripts/data/processed/hhi_divx/.
