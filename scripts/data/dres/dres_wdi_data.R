# Descargar insumos WDI para construir DRES y seleccionar la muestra.
#
# Este script solo prepara la capa raw utilizada para contrastar los resultados.
# La construcción principal con Atlas y las muestras de 20 %, 30 % y 40 % se
# realizan mediante dres_sample_selection.R en data/processed/dres/.
...
helper_path <- c(
  ...
  # Probar esta ruta cuando R se ejecuta desde scripts/data/dres/.
