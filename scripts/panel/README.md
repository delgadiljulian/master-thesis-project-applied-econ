...
El panel parte de la cuadrícula fija `DRES >= 20 %` e integra `RENTS`,
...
Las salidas contienen la cuadrícula fija de 1.430 país-años y 55 economías.
La intersección completa de variables empleada por las especificaciones
centrales reúne 1.044 país-años, 49 países y 23 años efectivos de WGI.
